...
export default function RaceCarMark() {
  return (
    <svg aria-hidden="true" height="31" viewBox="0 0 62 31" width="48">
      ...
      <path d="m22 4-5 7h26l-8-7Z" fill="var(--surface)" />
      <circle cx="14" cy="24" fill="var(--text)" r="6" />
      <circle cx="47" cy="24" fill="var(--text)" r="6" />
      <circle cx="14" cy="24" fill="var(--surface)" r="2.5" />
      <circle cx="47" cy="24" fill="var(--surface)" r="2.5" />
    </svg>
  );
}
